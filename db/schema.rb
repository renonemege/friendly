...
ActiveRecord::Schema.define(version: 2020_10_19_130031) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["friend_group_id"], name: "index_bookings_on_friend_group_id"
  ...
  add_foreign_key "bookings", "friend_groups"
